...
There are 3627 observations, which each represent a differen lemur that has resided at the Duke Lemur Center. Basic information about the lemur's species, birth, age, parents, and offspring are provided.
...
Lemurs with older mothers are expected to have lower lifespans and fewer offspring. The variable types we will use are as follows:

-   Categorical: Birth Type (`Birth_Type`)
