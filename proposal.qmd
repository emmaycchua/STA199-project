...
-   There are 2089 observations total, with 12 columns. Each observation is a different combination of the year observed and occupation (i.e., “2013” and “Legislators” is one row/observation). The variables of interest are the year, occupation, observation categories, how many workers there are in that occupation and the gender split, the proportion of female workers, total earnings and the gender split, and the percentage of a male wage that a woman earns.
