...
The gender pay gap narrowed a mere 4% from 2003 to 2024 generally, with women earning 19% less than men in 2003 and 15% less in 2024 (Fry & Aragão, 2025).
The closing of this wage gap is slow-moving, and strides towards resolution and full equality do not seem close.
Some studies estimate it taking anywhere between 63 to 134 years for women to earn as much as men for the same job (Holder 2025, The Gender).
Not only are these discrepencies unfair in the short term, but they also impact working women post-retirement: when paid less, women end up receiving less in Social Security and pensions and up to 30% less than men in retirement funds for the same job and number of years worked (The Simple).
