...
The disparities in wages are unfair, and accumulate to women only being able to save 70% as much as men on social security, on average (The Simple).
...
The gender pay gap is large and slowly moving, with estimations that it will take between 63 and 134 years to close (Holder 2025, The Gender).
We are interested in how gender pay gaps vary by percentages of female representation in the workforce, and by specific major job categories, such as the Management, Business, and Financial sector.
...
We will primarily consider the variables of female wages as a percent of male wages (`wage_percent_of_male`), major job category (`major_category`), and percentage of females in the workforce (`percent_female`). To clarify, if men make $100,000 and women make $90,000 for the same job, then `wage_percent_of_female` will equal 0.90.
