...
#| fig-asp: 0.6
#| fig-width: 10
ggplot(jobs_gender, aes(x = major_category, fill = male_dom_workforce)) +
...
Male-dominated workforces",
  ...
  theme(
    ...
    plot.margin = margin(t = 10, r = 15, b = 10, l = 30)
  )
```
...
Our null hypothesis is that female wage as a percent of male wage is independent to both the percent of females in the workforce and the major job category.
Our alternative hypothesis is that there is a relationship between the variables.
