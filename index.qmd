...
To clarify-- if women make 90 cents for every dollar men make doing the same job, then `wage_percent_of_female` will equal 0.90.
...
In order to begin exploring the data, we created the following three visualizations to understand the distribution of wage inequality across job categories, the proportion of male-majority workforces in each job category, and how the variation in how much women are paid compared with men. 
