...
The second visualization allowed us to learn that there is the least amount of female representation in careers in the nautral resources, construction, and maintenance category making it a male dominated field. However, the careers in sales/office, healthcare, and education are female-dominated.
```{r}
...
visualize(null_dist) +
  ...
  labs(x = "slope estimates", y = "count") +
  theme_minimal()
