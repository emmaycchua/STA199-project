...
We have also created a numerical variable of perc_male_earnings that measures the percentage of total workforce earnings that are from male employees. We are also creating the variable median_earnings_gap to measure the difference between male and female wages.
