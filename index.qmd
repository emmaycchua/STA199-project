...
Holding all other variables constant, for every additional percentage point of female employees in a Computer, Engineering, and Science category workforce, we expect the female wage as a percent of male wage to be lower, on average, by 13.8 percentage points. This intercept is inconsistent with our prediction that workforces with higher female representation will have higher female wages as a percent of male wages. The intercept and slope adjustments for non-baseline major job categories are given above. 
